...
class Recon(framework.Framework):
    ...
    repo_url = 'https://raw.githubusercontent.com/0x646e78/recon-ng-marketplace/master/'
    ...
    def _create_db(self):
        ...
        self.query('CREATE TABLE IF NOT EXISTS scope (value TEXT, column TEXT, action TEXT, notes TEXT, module TEXT)')
